...
# source: b4e_protobuf/voting.proto
...
Voting = _reflection.GeneratedProtocolMessageType('Voting', (_message.Message,), {

  'Vote' : _reflection.GeneratedProtocolMessageType('Vote', (_message.Message,), {
    'DESCRIPTOR' : _VOTING_VOTE,
    '__module__' : 'b4e_protobuf.voting_pb2'
...
VotingContainer = _reflection.GeneratedProtocolMessageType('VotingContainer', (_message.Message,), {

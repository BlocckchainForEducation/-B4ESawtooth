...
# source: b4e_protobuf/actor.proto
...
Actor = _reflection.GeneratedProtocolMessageType('Actor', (_message.Message,), {
  ...
  'Profile' : _reflection.GeneratedProtocolMessageType('Profile', (_message.Message,), {
    ...
    '__module__' : 'b4e_protobuf.actor_pb2'
...
ActorContainer = _reflection.GeneratedProtocolMessageType('ActorContainer', (_message.Message,), {
